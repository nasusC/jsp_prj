...
<link rel="stylesheet" type="text/css" href="http://localhost:8080/common/css/main_20240911.css">
<!-- bootstrap CDN 시작-->
...
<div id="wrap">
<div id="header">
<c:import url="http://localhost:8080/common/header.jsp"/>
</div>
