  ...
  (() => {
      ...
      if (n.length > 2) {
        ...
        if (i && 0 != e.offset && X(e)) {
          ...
          1 == a.nodeType
            ...
            : 3 != a.nodeType ||
              a.data.match(/[\n\r]/g) ||
              ((n = V((r = a), g.eq(t))), (e = { node: r, offset: 0 }));
        }
      }
    ...
    const pt = {
      ...
      splitPoint: function (t, e) {
        ...
        var s =
          o && ct(o, t, { isSkipPaddingBlankHTML: e, isNotSplitEdgePoint: e });
        return (
      ...
      return (
        (t = function t(e, o) {
          !(function (t, e) {
            ...
            (r().summernote.ui = r().summernote.ui_template(this.options)),
    ...
    r().fn.extend({
      summernote: function () {
        ...
        (n.langInfo = r().extend(
          ...
          (n.icons = r().extend(!0, {}, r().summernote.options.icons, n.icons)),
          (n.tooltip = "auto" === n.tooltip ? !m.isSupportTouch : n.tooltip),
          this.each(function (t, e) {
            var o = r()(e);
            if (!o.data("summernote")) {
              var i = new bt(o, n);
              o.data("summernote", i),
                o.data("summernote").triggerEvent("init", i.layoutInfo);
            }
          });
        var i = this.first();
        if (i.length) {
        ...
        (o = [
          {
            ...
            value: function () {
              if (m.isW3CRangeSupport) {
                ...
                return (
                  t.setStart(this.sc, this.so), t.setEnd(this.ec, this.eo), t
                );
              }
          ...
          },
          {
            ...
            value: function () {
              var e = function (t, e) {
                  ...
                  return (
                    (e
                      ? pt.nextPointUntil(pt.nextPoint(t), pt.isVisiblePoint)
                      : pt.prevPointUntil(
                          pt.prevPoint(t),
                          pt.isVisiblePoint
                        )) || t
                      ...
                      (n
                        ? (pt.isLeftEdgePoint(e) && s.push(e.node),
                          pt.isRightEdgePoint(e) &&
                            C.contains(s, e.node) &&
                            (i = e.node))
                        : (i = o ? pt.ancestor(e.node, t) : e.node),
                      i && t(i) && a.push(i));
                  },
                  !0
                ),
            ...
            value: function () {
              ...
              return (
                ...
                pt.isText(this.sc) &&
                  ...
                  (o.so = 0),
                  e && ((o.ec = o.sc), (o.eo = this.eo - this.so))),
            ...
            value: function () {
              ...
              return (
                r().each(o, function (t, e) {
                  var o = e.parentNode;
                  n.node !== o && 1 === pt.nodeLength(o) && i.push(o),
                    pt.remove(e, !1);
                }),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (pt.isInline(o.sc)) {
                ...
                (e = C.last(n)),
                  pt.isInline(e) ||
                    (e = n[n.length - 2] || o.sc.childNodes[o.so]);
              } else e = o.sc.childNodes[o.so > 0 ? o.so - 1 : 0];
              if (e) {
                var i = pt.listPrev(e, pt.isParaInline).reverse();
                if (
                  (i = i.concat(pt.listNext(e.nextSibling, pt.isParaInline)))
                    .length
                ) {
    ...
    const Et = {
      ...
      createFromNode: function (t) {
        var e = t,
          ...
          i = pt.nodeLength(n);
        return (
          pt.isVoid(e) && ((o = pt.listPrev(e).length - 1), (e = e.parentNode)),
          pt.isBR(n)
            ? ((i = pt.listPrev(n).length - 1), (n = n.parentNode))
            : pt.isVoid(n) && ((i = pt.listPrev(n).length), (n = n.parentNode)),
          this.create(e, o, n, i)
        );
      },
          ...
          },
          {
            ...
            value: function (t) {
              null !== t.contents && this.$editable.html(t.contents),
                null !== t.bookmark &&
                  Et.createFromBookmark(this.editable, t.bookmark).select();
            },
          },
          {
            key: "rewind",
        ...
        (e = [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                (o.anchor = t.isOnAnchor() && pt.ancestor(t.sc, pt.isAnchor)),
                (o.ancestors = pt.listAncestor(t.sc, pt.isEditable)),
                (o.range = t),
                o
              );
            },
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                ...
                r &&
                  (pt.appendChildNodes(a, C.from(r.childNodes), !0),
                  pt.remove(r)),
                t
              );
            },
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            ...
            value: function (t, e) {
              e = (e = (e =
                e || Et.create(t)).deleteContents()).wrapBodyInlineWithPara();
              var o,
                n = pt.ancestor(e.sc, pt.isPara);
              if (n) {
                if (pt.isLi(n) && (pt.isEmpty(n) || pt.deepestChildIsEmpty(n)))
                ...
                if (
                  (1 === this.options.blockquoteBreakingLevel
                    ...
                    : 2 === this.options.blockquoteBreakingLevel &&
                      (i = pt.lastAncestor(n, pt.isBlockquote)),
                  i)
                ) {
                  (o = r()(pt.emptyPara)[0]),
                  ...
                  (s = s.concat(pt.listDescendant(o, pt.isEmptyAnchor))),
        ...
        (e = [
                  ...
                  switch (a[s].action) {
                    ...
                    case Gt.resultAction.AddCell:
                      ...
                      u &&
                        (d > 2
                          ? (d--,
                            f.insertBefore(h, f.cells[n]),
                            f.cells[n].setAttribute("rowSpan", d),
                            (f.cells[n].innerHTML = ""))
                          : 2 === d &&
                            (f.insertBefore(h, f.cells[n]),
                            f.cells[n].removeAttribute("rowSpan"),
                            (f.cells[n].innerHTML = "")));
                      continue;
          ...
          },
          {
            ...
            value: function (t, e, o) {
              ...
              return (
                o && o.tableClassName && u.addClass(o.tableClassName), u[0]
              );
            },
          },
          {
          ...
          (t = function t(e) {
            ...
            for (
              ...
              (this[n[i]] = (function (t) {
                ...
                this.context.memo("help." + n[i], this.lang.help[n[i]]);
            ...
            (this.insertParagraph = this.wrapCommand(function () {
              ...
              (this.insertNode = this.wrapCommand(function (t) {
                o.isLimited(r()(t).text().length) ||
                  ...
                  o.setLastRange(Et.createFromNodeAfter(t).select()));
              })),
              ...
              (this.insertHorizontalRule = this.wrapCommand(function () {
                ...
                t.nextSibling &&
                  o.setLastRange(
                    Et.create(t.nextSibling, 0).normalize().select()
                  );
              })),
              ...
              (this.createLink = this.wrapCommand(function (t) {
                ...
                if (!(u > 0 && o.isLimited(u))) {
                  ...
                  var f = [];
                  if (d) {
                    var h = (c = c.deleteContents()).insertNode(
                      r()("<A></A>").text(i)[0]
                    );
                    f.push(h);
                  } else
                  ...
                  r().each(f, function (t, o) {
                    r()(o).attr("href", n),
                      a
                        ? (r()(o).attr("target", "_blank"),
                          s && e.push("noreferrer"),
                          l && e.push("noopener"),
                          e.length && r()(o).attr("rel", e.join(" ")))
              ...
              (this.insertTable = this.wrapCommand(function (t) {
                ...
                o.getLastRange()
                  .deleteContents()
                  .insertNode(o.table.createTable(e[0], e[1], o.options));
              })),
              (this.removeMedia = this.wrapCommand(function () {
                ...
                t.closest("figure").length
                  ...
                  o.setLastRange(Et.createFromSelection(t).select()),
          ...
          (e = [
              ...
              value: function (t) {
                ...
                if ("TAB" !== n || this.options.tabDisable)
                  if (i) {
                    ...
                    Nt.isEdit(t.keyCode) &&
                      (Nt.isRemove(t.keyCode) && this.context.invoke("removed"),
                      this.afterCommand());
                ...
                return (
                  ...
                  (void 0 === e ||
                    !(
                      ...
                      e.ctrlKey ||
                      e.metaKey ||
                      C.contains([Nt.code.BACKSPACE, Nt.code.DELETE], e.keyCode)
                    )) &&
            ...
            },
            {
              ...
              value: function (t) {
                t
                  ? (this.lastRange = t)
                  : ((this.lastRange = Et.create(this.editable)),
                    0 ===
                      r()(this.lastRange.sc).closest(".note-editable").length &&
                      (this.lastRange = Et.createFromBodyElement(
                        this.editable
                      )));
              },
            },
            ...
            },
            {
              ...
              value: function (t, e, o) {
                (t = Et.create()).isCollapsed() &&
                  ...
                  ("P" === o
                    ? e.remove()
                    : ["TH", "TD"].indexOf(o) >= 0 && e.firstChild.remove());
              },
            },
            {
              key: "insertImage",
                    ...
                    n.beforeCommand(),
                      "function" == typeof e
                        ...
                        : ("string" == typeof e && t.attr("data-filename", e),
                          t.css(
                            "width",
                            Math.min(n.$editable.width(), t.width())
                          )),
                      t.show(),
                      n.getLastRange().insertNode(t[0]),
                      n.setLastRange(Et.createFromNodeAfter(t[0]).select()),
                      n.afterCommand();
                  })
                  .fail(function (t) {
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  t.isOnAnchor() &&
                    (t = Et.createFromNode(pt.ancestor(t.sc, pt.isAnchor))),
                  t.toString()
                );
              },
            },
              ...
              value: function (t, e) {
                ...
                if ("" !== o) {
                  ...
                  if (
                    ...
                    i &&
                      !pt.nodeLength(i) &&
                      ((i.innerHTML = pt.ZERO_WIDTH_NBSP_CHAR),
                      Et.createFromNode(i.firstChild).select(),
                      this.setLastRange(),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  e.length && (o.isNewWindow = "_blank" === e.attr("target")), o
                );
              },
            },
            {
              ...
              if (!this.context.isDisabled()) {
                ...
                if (o && o.items && o.items.length) {
                  var n = o.files,
                    i = o.getData("Text");
                  n.length > 0 &&
                    this.options.allowClipboardImagePasting &&
                    (this.context.invoke("editor.insertImagesOrCallback", n),
                    t.preventDefault()),
                    i.length > 0 &&
                  ...
                  this.context.invoke("editor.isLimited", r.length) &&
                    t.preventDefault();
                }
                setTimeout(function () {
                  ...
                  .on("drop", function (e) {
                    ...
                    e.preventDefault(),
                      o && o.files && o.files.length
                        ...
                        : r().each(o.types, function (e, n) {
                            if (!(n.toLowerCase().indexOf("_moz_") > -1)) {
                              var i = o.getData(n);
                              n.toLowerCase().indexOf("text") > -1
                                ? t.context.invoke("editor.pasteHTML", i)
                                : r()(i).each(function (e, o) {
        ...
        (e = [
          {
            ...
            value: function () {
              ...
              this.options.airMode || this.options.disableResizeEditor
                ? this.destroy()
                : this.$statusbar.on("mousedown touchstart", function (e) {
                      ...
                      i = function (e) {
                        ...
                        (r =
                          t.options.minheight > 0
                            ? Math.max(r, t.options.minheight)
                            : r),
                          (r =
                            t.options.maxHeight > 0
                              ? Math.min(r, t.options.maxHeight)
                              : r),
                          (a =
                            t.options.minheight > 0
                              ? Math.max(a, t.options.minheight)
                              : a),
                          (a =
                            t.options.maxHeight > 0
                              ? Math.min(a, t.options.maxHeight)
                              : a),
                          t.$editable.height(r),
                          t.$codable.height(a);
                      };
                  ...
                  if (pt.isControlSizing(e.target)) {
                    ...
                    var o = t.$handle
                      ...
                      r = function (e) {
                        t.context.invoke(
                          "editor.resizeTo",
                          { x: e.clientX - n.left, y: e.clientY - (n.top - i) },
                          o,
                          !e.shiftKey
                        ),
                          t.update(o[0], e);
            ...
            },
            {
              ...
              value: function () {
                if (this.lastWordRange) {
                  ...
                  if (e && (e[1] || e[2])) {
                    var o = e[1] ? t : "http://" + t,
                      n = this.options.showDomainOnlyForAutolink
                        ? t
                            .replace(
            ...
            },
            {
              ...
              value: function (t) {
                (Nt.code.SPACE === t.keyCode ||
                  (Nt.code.ENTER === t.keyCode && !t.shiftKey)) &&
                  this.replace();
              },
            },
          ]) && $e(t.prototype, e),
      ...
      return (
        ...
        (e = [
          ...
          },
          {
            ...
            value: function () {
              var t = this;
              (this.$placeholder = r()('<div class="note-placeholder"></div>')),
                this.$placeholder
                  .on("click", function () {
        ...
        (e = [
          {
            ...
            value: function (t) {
              ...
              return this.options.shortcuts && e
                ? (m.isMac && (e = e.replace("CMD", "⌘").replace("SHIFT", "⇧")),
                  " (" +
                    (e = e
                      .replace("BACKSLASH", "\\")
                      .replace("SLASH", "/")
                    ...
                    this.button({
                      ...
                      callback: function (t) {
                        ...
                        o &&
                          ...
                          n
                            ? (e.css("color", i.options.colorButton.foreColor),
                              t.attr(
                                "data-foreColor",
                ...
                this.context.memo("button.clear", function () {
                  return t
                    .button({
                      ...
                      tooltip:
                        t.lang.font.clear + t.representShortcut("removeFormat"),
                ...
                this.context.memo("button.fontname", function () {
                  ...
                  return (
                    t.options.addDefaultFonts &&
                      r().each(e["font-family"].split(","), function (e, o) {
                        (o = o.trim().replace(/['"]+/g, "")),
                          t.isFontDeservedToAdd(o) &&
                            -1 === t.options.fontNames.indexOf(o) &&
                            t.options.fontNames.push(o);
                      }),
                    t.ui
                      .buttonGroup([
                        t.button({
          ...
          },
          {
            ...
            value: function () {
              ...
              this.options.otherStaticBar &&
                (i = r()(this.options.otherStaticBar).outerHeight());
            ...
            },
            {
              ...
              value: function (t) {
                ...
                t.on("blur", function (t) {
                  t.target.value =
                    "" == t.target.value ? "" : e.checkLinkUrl(t.target.value);
                });
              },
            },
            {
            ...
            value: function (t, e) {
              if (pt.isImg(t)) {
                ...
                this.options.popatmouse
                  ? ((i.left = e.pageX - 20), (i.top = e.pageY))
                  : (i = o),
                  (i.top -= n.top),
                  (i.left -= n.left),
                  this.$popover.css({
        ...
        (e = [
          ...
          },
          {
            ...
            value: function (t) {
              if (this.context.isDisabled()) return !1;
              var e =
                pt.isCell(t) || pt.isCell(null == t ? void 0 : t.parentElement);
              if (e) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (o && 11 === o[1].length) {
                ...
                if (void 0 !== o[2]) {
                  ...
                  if (y)
                    for (var k = [3600, 60, 1], w = 0, C = k.length; w < C; w++)
                      b +=
                        void 0 !== y[w + 1] ? k[w] * parseInt(y[w + 1], 10) : 0;
                ...
                e = r()("<iframe>")
                  .attr("frameborder", 0)
                  .attr("src", "https://instagram.com/p/" + i[2] + "/embed/")
                  .attr("width", "612")
                  .attr("height", "710")
                  .attr("scrolling", "no")
              ...
              (this.lastWordRange = null),
                ...
                this.$content.on("click", ".note-hint-item", function (e) {
                  t.$content.find(".active").removeClass("active"),
                    r()(e.currentTarget).addClass("active"),
                    t.replace();
                }),
                this.$popover.on("mousedown", function (t) {
                  t.preventDefault();
          ...
          },
          {
            ...
            value: function () {
              ...
              if (e.length) this.selectItem(e);
                ...
                var o = t.parent().next();
                o.length ||
                  (o = this.$content.find(".note-hint-group").first()),
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return e.map(function (e, n) {
                ...
                return (
                  i.append(o.template ? o.template(e) : e + ""),
            ...
            value: function (t, e) {
              ...
              return (
                this.searchKeyword(t, e, function (e) {
                  (e = e || []).length &&
                    (n.html(o.createItemTemplates(t, e)), o.show());
                }),
                n
              );
            },
                ...
                if ("words" === this.options.hintMode) {
                  if (
                    ...
                    this.hints.forEach(function (t) {
                      if (t.match.test(n))
                        return (o = i.getWordsMatchRange(t.match)), !1;
                    }),
                    !o)
                  )
                ...
                if (this.hints.length && n) {
                  ...
                  a &&
                    ...
                    this.hints.forEach(function (t, o) {
                      t.match.test(n) &&
                        e.createGroup(o, n).appendTo(e.$content);
                    }),
                    this.$content
                      .find(".note-hint-item")
                      .first()
        ...
        (e = [
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                this.options &&
                  this.options.data &&
                  r().each(this.options.data, function (t, o) {
                    e.attr("data-" + t, o);
                  }),
                this.options &&
                  this.options.click &&
    ...
    var Vo = Ko('<div class="note-editor note-frame card"></div>'),
              ...
              [
                ...
                e.title
                  ? '<div class="modal-header"><h4 class="modal-title">' +
                    e.title +
                    '</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true"></button></div>'
                  : "",
      ...
      an = Ko(
        ...
        function (t, e) {
          ...
          t.attr("data-popper-placement", o),
            e.hideArrow && t.find(".popover-arrow").hide();
        }
      ),
    ...
    return (
      (r().summernote = r().extend(r().summernote, {
        ui_template: function (t) {
          return {
            ...
            button: function (e, o) {
              return Ko(
                '<button type="button" class="note-btn btn btn-outline-secondary btn-sm" tabindex="-1">',
                function (e, o) {
                  o && o.data && "dropdown" === o.data.toggle
                    ? (e.removeAttr("data-toggle"),
                      e.attr("data-bs-toggle", "dropdown"),
                      o &&
                        o.tooltip &&
                        e.attr({ title: o.tooltip, "aria-label": o.tooltip }))
                    : o &&
                      o.tooltip &&
                      e
      ...
      (r().summernote.options.styleTags = [
        "p",
        {
          title: "Blockquote",
          tag: "blockquote",
